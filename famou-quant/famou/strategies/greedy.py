...
def create_strategy(
    ...
    **kwargs
    ...
    - Keep all programs without pruning (full archive)
    ...
    population_module = FullArchivePopulation(**population_params)

    return {
        "rollout": rollout,
        "population_module": population_module,
        "description": "Standard exploitation strategy (best parent + mutation, full archive)",
        "tags": ["exploitation", "standard", "default"],
        "author": "Famou Framework",
    }
