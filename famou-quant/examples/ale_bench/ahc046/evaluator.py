...
def evaluate(
    path_user_py,
    input_dir="/mnt/cfs_bj_mt/workspace/lihuaiming/ALE-Bench/ahc046/tools/in",
    evaluator_file="/mnt/cfs_bj_mt/workspace/lihuaiming/ALE-Bench/ahc046/tools/target/debug/tester",
    language="C++17",
    timeout=2.0,
    score_type="maximize",
    problem_type="batch",
...
if __name__ == "__main__":
    result = evaluate(
        "/mnt/cfs_bj_mt/workspace/lihuaiming/fm_output_ModelTest/ahc016/ahc011-try5/claude-sonnet-4-5-20250929-and-None/2026-01-09_16-59-39/evolve/checkpoints/checkpoint_5/island_0/programs/e3e941d2-112d-4840-badb-c9b64e74df63.cpp",
        input_dir="/mnt/cfs_bj_mt/workspace/wuchufan/ALE-Bench/ahc016/tools/in",
        evaluator_file="/mnt/cfs_bj_mt/workspace/wuchufan/ALE-Bench/ahc016/tools/target/debug/tester",
        language="C++",
        timeout=2.0,
        score_type="maximize",
        problem_type="batch",
