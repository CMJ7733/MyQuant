...
def evaluate(
    path_user_py,
    input_dir="/mnt/cfs_bj_mt/workspace/lihuaiming/ALE-Bench/ahc015/tools/in",
    evaluator_file="/mnt/cfs_bj_mt/workspace/lihuaiming/ALE-Bench/ahc015/tools/target/debug/tester",
    language="C++17",
    timeout=2.0,
    score_type="maximize",
